...
@$core.Deprecated('Use combatDescriptor instead')
const Combat$json = {
  '1': 'Combat',
  '2': [
    {
    ...
    {'1': 'round', '3': 7, '4': 1, '5': 5, '10': 'round'},
  ],
};

/// Descriptor for `Combat`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List combatDescriptor = $convert.base64Decode(
    ...
    'bWVzdGFtcBIOCgJJZBgGIAEoCVICSWQSFAoFcm91bmQYByABKAVSBXJvdW5k');
